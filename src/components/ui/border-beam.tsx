...
export function BorderBeam({
	...
	return (
		...
		>
			...
			>
				<div
					className="absolute top-0 left-0 w-full aspect-square bg-gradient-to-l from-[var(--color-from)] via-[var(--color-to)] to-transparent opacity-0 animate-border-beam [animation-delay:var(--delay)]"
